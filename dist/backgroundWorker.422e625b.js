...
class worker {
    ...
    draw() {
        ...
        if (ctx) {
            ...
            (0, _d3Selection.select)(this.dom).selectAll("custom.section").each(function(d, i) {
                const path = (0, _d3Selection.select)(this).select("path"), id = (0, _d3Selection.select)(this).attr("id"), fill = path.attr("fill"), opacity = +path.attr("opacity"), svgPath = path.attr("d");
    ...
    initChart(ringSet, ringHeights, sliceSet, sliceAngles, sliceColors) {
        ...
        (0, _d3Selection.select)(this.dom).call(this.background.queue(queue).generator((0, _d3Shape.arc)()).interpolator((0, _d3Interpolate.interpolate)).draw(()=>this.draw()));
    }
...
},{"d3-selection":"6ZzI7","d3-interpolate":"diZln","d3-shape":"fVWdL","../static/queue":"1rujW","../d3/renderBackground":"ehvhk","svg-path-properties":"cdmva","earcut":"bepWE","../domparser_bundle":"82hnu","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"1rujW":[function(require,module,exports) {
