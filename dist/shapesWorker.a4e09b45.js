importScripts("./backgroundWorker.1020577a.js");
...
})({"dt1jz":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "a8fb9c35fdafe466";
module.bundle.HMR_BUNDLE_ID = "a1f93c0ba4e09b45";
"use strict";
...
},{}],"dGLdy":[function(require,module,exports) {
...
class worker {
    ...
    updateCoords(coords) {
        ...
        if (ctx) {
            ...
            for(let i = 0; i < coords.length; ++i){
                ...
                const path = (0, _d3Shape.symbol)((0, _d3Shape.symbolCircle)).size(r * r * Math.PI)() || "";
    ...
    draw() {
        ...
        if (ctx) {
            ...
            ctx.beginPath();
            (0, _d3Selection.select)(this.dom).selectAll("custom.section").each(function(d, i) {
                const path = (0, _d3Selection.select)(this).select("path"), fill = path.attr("fill"), opacity = +path.attr("opacity"), svgPath = path.attr("d");
...
self.addEventListener("message", (msg)=>{
    const { type , canvas , w , h , r , coords  } = msg.data;
    if (type === "set_ctx" && canvas) {
        const ctx = canvas.getContext("2d");
        brw.setContext(ctx);
    }
    if (type === "set_dimensions" && w && h && r) brw.setDimensions(w, h, r);
    if (type === "update_coords" && coords) brw.updateCoords(coords);
});
function pointOnLine(v1, v2) {
    // console.log(v1, v2)
...
},{"d3-shape":"fVWdL","../d3/renderBackground":"ehvhk","../domparser_bundle":"82hnu","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk","d3-selection":"6ZzI7"}]},["dt1jz","dGLdy"], "dGLdy", "parcelRequiredb4e")

//# sourceMappingURL=shapesWorker.a4e09b45.js.map
