importScripts("./backgroundWorker.d3ced8f1.js");
    ...
    draw() {
        ...
        if (ctx) {
            ...
            (0, _d3.select)(this.dom).selectAll("custom.section").each(function(d, i) {
                const path = (0, _d3.select)(this).select("path"), fill = path.attr("fill"), opacity = +path.attr("opacity"), svgPath = path.attr("d");
...
},{"d3":"7K7cD","d3-shape":"fVWdL","../d3/renderBackground":"ehvhk","../domparser_bundle":"82hnu","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}]},["dt1jz","dGLdy"], "dGLdy", "parcelRequiredb4e")
